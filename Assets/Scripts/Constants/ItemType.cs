...
namespace GloriousWhale.BeansJam17.Assets.Scripts.Constants
{
	public class ItemType
	{
		...
		public static readonly ItemType ThrustTier2 =
			new ItemType("thrust_tier_2", "Upgraded Thruster", 25, SlotType.Thruster);
		...
		public static IEnumerable<ItemType> Values
		{
			get
			{
				...
				yield return ShieldTier1;
				yield return ShieldTier2;
				yield return ShieldTier3;
